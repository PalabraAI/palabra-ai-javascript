...
onMounted(async () => {
  ...
  palabraClient.on(EVENT_REMOTE_TRACKS_UPDATE, (data) => {
    ...
    if (audioElement.value) {
      audioElement.value.srcObject = new MediaStream(data.map(track => track.track));
...
<template>
  <div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
      <h2 class="text-2xl font-bold mb-6 text-center">Translator Example with Audio Element</h2>
